            ...
            >
                ...
                <div className="relative z-10">
                    <h1 className="text-5xl font-bold text-white leading-tight mb-4 drop-shadow-lg">
                        Smart Tracking<br />for <span className="text-blue-400">Smoother</span><br />Journeys
                    </h1>
                    <p className="text-gray-200 mb-10 leading-relaxed max-w-sm">
                        Track your vehicle maintenance, get timely reminders, and keep your ride always in perfect condition.
                    </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-900">
                <div className="w-full max-w-md">
                    ...
                    <div className="flex border-b border-gray-700 mb-8">
                        ...
                        <Link to="/register" className="pb-3 px-4 text-gray-400 hover:text-white text-sm transition flex items-center gap-2">
                            <img src={userPlusIcon} alt="" className="w-4 h-4 opacity-60" />
                            Sign Up
                        </Link>
                    </div>
